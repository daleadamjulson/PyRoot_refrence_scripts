...
output_root_file = ROOT.TFile.Open("temp/Merged_output.root","RECREATE")
...
def merge_histos(signal_histo, background_histo, input_root_file, output_root_file):
	...
	stack_name = new_histo_name.replace("_", " ")

	hs1 = ROOT.THStack(stack_name, stack_name)
	...
	hs2 = ROOT.THStack(stack_name, stack_name)
	...
	legend = ROOT.TLegend(0.7, 0.75, .99, .85)
